...
| **Run the Application**   | Start the application with:<br>```python3 downloader.py```                                                    |
...
| **2.**    | Navigate to the directory where `downloader.py` is located.                 | ![Navigate](https://img.shields.io/badge/Navigate-%2334A853.svg?style=for-the-badge&logo=folder&logoColor=white) |
| **3.**    | Run the command: `python3 downloader.py`                                    | ![Command](https://img.shields.io/badge/Run%20Command-%23007BFF.svg?style=for-the-badge&logo=python&logoColor=white) |
